...
def generate_dungeon(map_width: int, map_height: int, room_max_size: int, room_min_size: int, max_rooms: int, max_monsters_per_room: int, max_items_per_room: int, engine: Engine) -> GameMap:
